...
//            }
    ...
    public static void main(String[] args) {
        ...
        re.reduction();
        String str = "";
        for (MySentence sentence : re.sentences) {
            str += " " + MyStringUtil.capitalize(sentence.tokensList.get(0).word);
...
//            str += "\n";
        ...
        System.out.println("Số từ: " + str.split("\\s+").length);
    }
}
